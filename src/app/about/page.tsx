      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-5 max-w-3xl mx-auto text-[var(--color-text-soft)] leading-8 text-lg">
            রক্তদান একটি স্থানীয় অনলাইন প্ল্যাটফর্ম যেখানে হোমনা থানার বিভিন্ন
            গ্রামের মানুষ একসাথে যুক্ত হয়ে জরুরি মুহূর্তে দ্রুত রক্তদাতা খুঁজে
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="card">
            ...
            <p className="mt-4 text-[var(--color-text-soft)] leading-8">
              হোমনা থানার প্রতিটি গ্রামের মানুষের জন্য একটি নির্ভরযোগ্য রক্তদাতা
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card text-center">
              ...
              <p className="mt-3 text-[var(--color-text-soft)] leading-7">
                শুধুমাত্র হোমনা থানার মানুষদের নিয়ে গড়ে ওঠা বিশ্বস্ত প্ল্যাটফর্ম।
              </p>
            </div>
